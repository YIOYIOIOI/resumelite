...
describe("getWebFontSource", () => {
	it("uses bundled local font files for Noto Serif SC PDF rendering", () => {
		expect(getWebFontSource("Noto Serif SC", "400")).toBe("/fonts/noto-serif-sc/NotoSerifSC-400.ttf");
		expect(getWebFontSource("Noto Serif SC", "600")).toBe("/fonts/noto-serif-sc/NotoSerifSC-600.ttf");
		expect(getWebFontSource("Noto Serif SC", "700")).toBe("/fonts/noto-serif-sc/NotoSerifSC-700.ttf");
	});
