import type { Locale, Script } from "@resumelite/utils/locale";
import { unique } from "@resumelite/utils/field";
import { getLocaleScript, isCjkScript } from "@resumelite/utils/locale";
...
const localPdfFontSources: Partial<Record<string, Partial<Record<FontWeight, string>>>> = {
	"Noto Serif SC": {
		"400": "/fonts/noto-serif-sc/NotoSerifSC-400.ttf",
		"600": "/fonts/noto-serif-sc/NotoSerifSC-600.ttf",
		"700": "/fonts/noto-serif-sc/NotoSerifSC-700.ttf",
	},
};
...
export function getWebFontSource(family: string, weight: FontWeight = "400", italic = false) {
	...
	const localSource = localPdfFontSources[family]?.[weight];
...
/**
 * Back-compat single-font resolver kept for the public `@resumelite/fonts`
