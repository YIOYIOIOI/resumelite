...
import type { ResumeData, StyleIntent, StyleSlot } from "@resumelite/schema/resume/data";
import type { SectionStyleRuleContext } from "@resumelite/schema/resume/style-rules";
import { getSectionStyleRuleContext, resolveStyleIntentForSlot } from "@resumelite/schema/resume/style-rules";
import { rgbaStringToHex } from "@resumelite/utils/color";
