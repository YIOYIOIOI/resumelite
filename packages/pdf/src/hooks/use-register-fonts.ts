import type { FontWeight } from "@resumelite/fonts";
import type { ResumeData, Typography } from "@resumelite/schema/resume/data";
...
import {
	...
	sortFontWeights,
} from "@resumelite/fonts";
import { isCJKLocale } from "@resumelite/utils/locale";
