import type { ResumeData, SectionType } from "@resumelite/schema/resume/data";
...
import { parseColorString } from "@resumelite/utils/color";
...
const TEMPLATE_CONFIGS: Record<Template, TemplateConfig> = {
	"ai-product": { sidebarSide: "none", sidebarBackground: "none", headerPosition: "full-width" },
