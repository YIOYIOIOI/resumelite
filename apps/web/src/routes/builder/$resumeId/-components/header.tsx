...
function BuilderHeaderDropdown() {
	...
	const handleToggleLock = async () => {
		...
		await updateLocalResume(id, { isLocked: !isLocked });
		patchResume((draft) => {
	...
	const handleDelete = async () => {
		...
		await deleteLocalResume(id);
		toast.success(t`Your resume has been deleted successfully.`, { id: toastId });
		void navigate({ to: "/dashboard/resumes", search: { sort: "lastUpdatedAt", tags: [], view: "grid" } });
	};
	...
	return (
		<DropdownMenu>
			...
			<DropdownMenuContent>
				...
				<DropdownMenuItem variant="destructive" disabled={isLocked} onClick={() => void handleDelete()}>
