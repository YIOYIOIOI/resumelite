...
import type { Locale } from "@resumelite/utils/locale";
...
import { DirectionProvider } from "@resumelite/ui/components/direction";
import { Toaster } from "@resumelite/ui/components/sonner";
import { TooltipProvider } from "@resumelite/ui/components/tooltip";
...
const description =
	"ResumeLite is a free and open-source resume builder that simplifies the process of creating, updating, and sharing your resume.";

export const Route = createRootRouteWithContext<RouterContext>()({
	component: RootComponent,
	head: () => {
		const appUrl = typeof window !== "undefined" ? window.location.origin : "https://resumelite.app";
		...
		return {
			...
			meta: [
				...
				{ name: "application-name", content: "ResumeLite" },
				{ name: "mobile-web-app-capable", content: "yes" },
				{ name: "apple-mobile-web-app-capable", content: "yes" },
				{ name: "apple-mobile-web-app-title", content: "ResumeLite" },
